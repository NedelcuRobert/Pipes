...
int prime_num(int low, int high, int* fd) {
    int i;
    int flag;
    char buffer[20];
...
int prime_first(int low, int high) {
    int i;
    int flag;
    char buffer[20];
    ...
    for (i = 0; i < 10; i++)
    {
        ...
        if (pid == 0)
        {
            ...
            else
            {
                ...
                prime_num(i * 1000 + 1, (i + 1) * 1000, mypipe[i]); //calculate the rest of the intervals    
